...
with open('structure_v105.json', encoding='utf-8') as f:
...
l1_features = [
    ...
    {"feature_id": "feat-ui-server", "label": "Local Web UI Server", "description": "Starts a localhost HTTP server serving the graph visualization frontend with drawer navigation, mindmap view, zoom controls, legend rendering, and REST API for L1/L2 data.", "source_node_count": 70, "confidence": "high"},
