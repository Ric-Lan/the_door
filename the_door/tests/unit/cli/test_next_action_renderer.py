...
def test_render_human_outputs_numbered_next_block(capsys):
    ...
    actions = [
        NextAction(id="extract.backfill", title="補結構", rationale="r", priority=1, cli_command="the-door extract --as-version v1.0.0 ."),
    ...
    assert "the-door extract --as-version v1.0.0" in captured.err
