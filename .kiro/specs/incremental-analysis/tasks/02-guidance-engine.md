...
_RULES: list[_Rule] = [
    ...
    (lambda s: s.has_structure_json and not s.snapshots, ("mcp",), _rule_snapshot_write_first),
    ...
    (lambda s: bool(s.snapshots) and not all(e.has_persisted_structure for e in s.snapshots), ("cli",), _rule_backfill),
